...
/* the timeout of BLE ADV */
#define BLEWIFI_CTRL_BLEADV_TIMEOUT                     (180000)  // ms
...
#define IOT_UART0_RECV_WITH_TIMER_METHO_EN              (1)     // 1: enable / 0: disable

/* TCP CLIENT CONFIG */
#define TCP_SERVER_ADDR                                 "192.168.50.125"
#define TCP_PORT                                        8181
#define TCP_TX_TIMEOUT                                  (5000)      // ms
#define TCP_RX_TIMEOUT                                  (5000)      // ms

#define TCP_RX_BUFFER_SIZE                              (1024)      // byte

#define TCP_OS_TASK_PRIORITY                            osPriorityBelowNormal

#define TCP_HEARTBEAT_TIMER_EN                          (0)         // 1: enable / 0: disable
#define TCP_HEARTBEAT_TIMEOUT                           (1200000)   // ms
#define TCP_LOOPBACK_TEST_MODE_EN                       (0)         // 1: enable / 0: disable
